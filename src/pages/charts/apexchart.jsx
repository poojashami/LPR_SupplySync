  ...
  return (
    <Grid container spacing={3}>
      <Grid item xs={12} md={6}>
        <MainCard title="Column Chart">{/* <ApexColumnChart /> */}</MainCard>
      </Grid>
      <Grid item xs={12} md={6}>
        <MainCard title="Bar Chart">{/* <ApexBarChart /> */}</MainCard>
      </Grid>
      <Grid item xs={12} md={6} lg={6}>
        <MainCard title="Line Chart">{/* <ApexLineChart /> */}</MainCard>
      </Grid>
      <Grid item xs={12} md={6} lg={6}>
        <MainCard title="Area Chart">{/* <ApexAreaChart /> */}</MainCard>
      </Grid>
      <Grid item xs={12} md={6} lg={8}>
        <MainCard title="Mixed Chart">{/* <ApexMixedChart /> */}</MainCard>
      </Grid>
      <Grid item xs={12} sm={6} lg={4}>
        <MainCard title="Redial Chart">{/* <ApexRedialChart /> */}</MainCard>
      </Grid>
      <Grid item xs={12} sm={6} xl={4}>
        <MainCard title="Polar Chart">{/* <ApexPolarChart /> */}</MainCard>
      </Grid>
      <Grid item xs={12} sm={6} xl={4}>
        <MainCard title="Pie Chart">{/* <ApexPieChart /> */}</MainCard>
      </Grid>
    </Grid>
  );
}
