...
const QuoteAirFrieght = () => {
  ...
  return (
    <MainCard title={'Quote for Air Freight'}>
      <Table>
        ...
        <Grid container spacing={2} alignItems="center">
          ...
          <Grid item xs={12} sm={2}>
            <CustomTypography variant="body">
              Air Line <ValidationStar>*</ValidationStar>
            </CustomTypography>
            <TextField
              sx={{
                '& .MuiInputBase-input': {
              ...
              variant="outlined"
              name="air_line"
              value={formValuesInvoice?.air_line}
              onChange={(e) => setFormValuesInvoice({ ...formValuesInvoice, [e.target.name]: e.target.value })}
            />
          </Grid>
          <Grid item xs={12} sm={2}>
...
export default QuoteAirFrieght;
