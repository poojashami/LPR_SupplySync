...
export default function FinalNPANGNPage() {
  const initialExpenses = [{ expense: 'Wharfage Charges', unit: '', rate_usd: '', amount_usd: '', remark: '' }];
    ...
    <MainCard
      title={
        <Box display="flex" justifyContent="space-between" alignItems="center">
          Final Bulk NPA Expense Detail(NGN)
          {/* <PlusButton
            label="Back"
            onClick={() => {
