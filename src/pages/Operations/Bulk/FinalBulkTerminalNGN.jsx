...
export default function FinalBulkTerminalNGN() {
  const initialExpenses = [
    { expense: 'Handling Ch', unit: '', rate_usd: '', amount_usd: '', amount_ngn: '', remark: '' },
    { expense: 'Mechanical Equipement CH', unit: '', rate_usd: '', amount_usd: '', amount_ngn: '', remark: '' },
    { expense: 'Documentation Ch', unit: '', rate_usd: '', amount_usd: '', amount_ngn: '', remark: '' },
    { expense: 'Tally Sheet Ch', unit: '', rate_usd: '', amount_usd: '', amount_ngn: '', remark: '' },
    { expense: 'Environment Pollution Ch', unit: '', rate_usd: '', amount_usd: '', amount_ngn: '', remark: '' },
    { expense: 'Weighbridge Ch', unit: '', rate_usd: '', amount_usd: '', amount_ngn: '', remark: '' },
    { expense: 'Harzardous Ch', unit: '', rate_usd: '', amount_usd: '', amount_ngn: '', remark: '' },
  ...
  const TableHeader = () => (
    <TableHead>
      <TableRow>
        ...
        <TableCell>
          <Typography variant="body">Rate in NGN</Typography>
        </TableCell>
  ...
  // Add a new row
  const addNewRow = () => {
    setRows([...rows, { expense: '', unit: '', rate_usd: '', amount_usd: 0, remark: '' }]);
  };
    ...
    <MainCard
      title={
        <Box display="flex" justifyContent="space-between" alignItems="center">
          Final Bulk Terminal Expense Detail(NGN)
          {/* <PlusButton
            label="Back"
            onClick={() => {
