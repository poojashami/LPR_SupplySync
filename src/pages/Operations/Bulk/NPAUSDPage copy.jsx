...
export default function NPAUSDPage() {
  const initialExpenses = [
    { expense: 'Ship Dues (GRT x Tariff)', unit: '', rate_usd: '', amount_usd: '', amount_ngn: '', remark: '' },
    { expense: 'Towage Of Ship (LOA)', unit: '', rate_usd: '', amount_usd: '', amount_ngn: '', remark: '' },
    { expense: 'Berthing / Mooring', unit: '', rate_usd: '', amount_usd: '', amount_ngn: '', remark: '' },
    { expense: 'Berth rent', unit: '', rate_usd: '', amount_usd: '', amount_ngn: '', remark: '' },
    { expense: 'Harbour Dues', unit: '', rate_usd: '', amount_usd: '', amount_ngn: '', remark: '' },
    { expense: 'Environmental Protection', unit: '', rate_usd: '', amount_usd: '', amount_ngn: '', remark: '' },
    { expense: 'MOWCA', unit: '', rate_usd: '', amount_usd: '', amount_ngn: '', remark: '' },
    { expense: 'Contingency Deposit', unit: '', rate_usd: '', amount_usd: '', amount_ngn: '', remark: '' },
    { expense: 'VAT', unit: '', rate_usd: '', amount_usd: '', amount_ngn: '', remark: '' }
  ];
  ...
  const validationSchema = Yup.object({
    vesselLine: Yup.string().required('Shipment Line is required'),
    ...
    <MainCard
      title={
        <Box display="flex" justifyContent="space-between" alignItems="center">
          Provisional Bulk NPA Expense Detail(USD)
          <PlusButton
            label="Back"
            onClick={() => {
                ...
                {showTableHeading.invoiceDetail && (
                  <Grid container spacing={2} alignItems="center">
                    <Grid item xs={12} sm={2}>
                      ...
                      <Field as={FieldPadding} name="vesselLine" variant="outlined" fullWidth size="small" />
                      <ErrorMessage name="vesselLine" component="div" style={errorMessageStyle} />
                    </Grid>
