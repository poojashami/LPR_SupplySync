...
export default function BulkTerminalNGN() {
  const [expenses, setExpenses] = useState([
    ...
    {
      id: 2,
      expense: 'Mechanical Equipement CH',
      unit: '',
      rate_usd: '',
      amount_usd: '',
      amount_ngn: '',
    ...
    {
      id: 5,
      expense: 'Environment Pollution Ch',
      unit: '',
      rate_usd: '',
      amount_usd: '',
      amount_ngn: '',
    ...
    <MainCard
      title={
        <Box display="flex" justifyContent="space-between" alignItems="center">
          Provisional Bulk Terminal Expense Detail(NGN)
          <PlusButton
            label="Back"
            onClick={() => {
