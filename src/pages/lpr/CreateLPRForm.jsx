          ...
          <form onSubmit={handleSubmit}>
            <Grid container spacing={2}>
              <Grid item xs={12} sm={3} paddingTop={'20px'}>
                ...
                <FieldPadding name="lprDate" variant="outlined" fullWidth size="small" value={formValues.lprDate} onChange={handleChange} />
              ...
              <Grid item xs={12} sm={3} paddingTop={'20px'}>
                ...
                <FieldPadding name="company" variant="outlined" fullWidth size="small" value={formValues.company} onChange={handleChange} />
