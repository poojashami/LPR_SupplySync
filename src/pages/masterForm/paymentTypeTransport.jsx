...
export default function VerticalMode() {
  ...
  const [paymentTypeTransData, setPaymentTypeTransData] = useState([]);
  ...
  const gettransOperationLapse = async () => {
    try {
      ...
      setPaymentTypeTransData(transOperationLapseList);
    } catch (error) {
    ...
    <MainCard
      title={
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span>Payment Type Transport</span>
                    ...
                    <Grid container spacing={2} alignItems="center">
                      <Grid item xs={12} sm={1}>
                        <Typography variant="body1">
                          Payment Type Transport<ValidationStar>*</ValidationStar>
                        </Typography>
                      </Grid>
